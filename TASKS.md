...
Hakmi Holding only. Check off items here and close matching [GitHub Issues](https://github.com/Moaazaldakkak/hakmi-holding/issues) when done.
...
- [ ] **Homepage color invert + infinite partner carousel** — شركات المجموعة and شراكات استراتيجية opposite of master dark palettes; شركائنا seamless loop + hover scale (draft PR, `cursor/homepage-color-carousel-2c7d`)
...
- [ ] Keep **STATUS.md** updated with a dated bullet after each merged PR
- [ ] Keep this file and **GitHub Issues** in sync when opening or closing work
