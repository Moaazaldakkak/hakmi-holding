...
def companies_page():
    companies = [
        ("akzirve", "Akzirve - تركيا", "assets/logos/akzirve.png", "Akzirve", "تركيا", "التطوير والاستثمار العقاري",
        ...
        ("bayt-alibaa", "بيت الإباء - المملكة العربية السعودية", "assets/logos/bayt-alibaa.jpg", "بيت الإباء", "المملكة العربية السعودية", "مواد البناء والتشطيبات",
        ...
        ("qimam", "قمم - المملكة العربية السعودية", "assets/logos/qimam.png", "قمم", "المملكة العربية السعودية", "استشارات وتصنيع ولوجستيات",
